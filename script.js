...
function displayRecords() {
		...
		var totalAverageResponseTime =  document.getElementById("responseTime");
		...
		console.log("Hello");
		totalAverageResponseTime = jsListObj.averageTimeGlobal + "Hrs";
		console.log("Hello Again");
		console.log(jsListObj.averageTimeGlobal);
		console.log("...Hi");
